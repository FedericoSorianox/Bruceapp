...
export default function CultivoDetailPage() {
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-100 flex items-center justify-center">
        <div className="inline-flex items-center gap-3 p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
          <div className="animate-spin rounded-full h-8 w-8 border-4 border-green-200 border-t-green-600"></div>
          <span className="text-lg font-medium text-gray-600">Cargando cultivo...</span>
        </div>
      </main>
    );
  }
  ...
  if (error || !cultivo) {
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-100 flex items-center justify-center">
        <div className="text-center p-8 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg max-w-md mx-auto">
          <svg className="h-16 w-16 text-red-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Cultivo no encontrado</h2>
          <p className="text-gray-600 mb-6">{error || 'El cultivo solicitado no existe o fue eliminado'}</p>
          <Link 
            href="/cultivo"
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">{cultivo.nombre}</h1>
                <p className="text-gray-600">{cultivo.genetica || 'Información de cultivo'}</p>
              </div>
        ...
        {editing && (
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900">Editar cultivo</h3>
                <p className="text-gray-600 text-sm">Modifique los campos que desea actualizar</p>
              </div>
            </div>
            <CultivoForm
              initial={cultivo}
